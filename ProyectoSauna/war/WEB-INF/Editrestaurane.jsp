...
<% List<Restaurante> resta = (List<Restaurante>)request.getAttribute("restaurante");%>
...
<h2>Agregar Tipo de servicio en restaurante</h2>
...
<br> 
<h2>Borrar tipo de servicio en restaurante</h2> 
<select name="borrar">
<%for ( Restaurante re : resta ){%>
<option value="<%=re.getTipo() %>" ></option><%} %>
</select>
<%misesion.setAttribute("id", "restaurante"); %>
